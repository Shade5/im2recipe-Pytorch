...
REPLACEMENTS = {
    '\x91':"'", '\x92':"'", '\x93':'"', '\x94':'"', '\xa9':'',
    '\xba': ' degrees ', '\xbc':' 1/4', '\xbd':' 1/2', '\xbe':' 3/4',
    '\xd7':'x', '\xae': '',
    '\\u00bd':' 1/2', '\\u00bc':' 1/4', '\\u00be':' 3/4',
    '\\u2153':' 1/3', '\\u00bd':' 1/2', '\\u00bc':' 1/4', '\\u00be':' 3/4',
    '\\u2154':' 2/3', '\\u215b':' 1/8', '\\u215c':' 3/8', '\\u215d':' 5/8',
...
def prepro_txt(text):
    ...
    for unichar, replacement in list(REPLACEMENTS.items()):
...
def print_counts(counts):
    for item,count in sorted(list(counts.items()), key=lambda x: -x[1]):
